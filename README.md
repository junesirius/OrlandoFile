...
- 在\<head\>的\<link rel="icon"\>标签下设置本站的图标，图标存储位置为[favicon.jpg](https://github.com/junesirius/OrlandoFile/blob/master/assets/media/favicon.jpg)
...
- **头像**：图片存储于[icon.jpg](https://github.com/junesirius/OrlandoFile/blob/master/assets/media/icon.jpg)，显示为圆形。
...
包含大部分自定义的css格式，包括页眉、页脚、侧边栏、文章页的主要格式。设置个站背景纹理图片为[canvas_bg.jpg](https://github.com/junesirius/OrlandoFile/blob/master/assets/media/canvas_bg.jpg)。
